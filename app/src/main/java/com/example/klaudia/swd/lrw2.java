    ...
    */
    ...
    public List<List<Boolean>> policz(List<Integer> choices){
        ...
        for (int i = 0; i < rows; i++) {
            ...
            Boolean F1 = !tmp.get(10) || (tmp.get(3) && tmp.get(9) && tmp.get(5)); //rzym
            ...
            Boolean F5 = !tmp.get(14) || (/*tmp.get(2) && tmp.get(4) &&*/tmp.get(2)&& tmp.get(8)); //alpy
            ...
            Boolean F8 = !tmp.get(5)|| !(tmp.get(2));//za zimno na opalanie sie
